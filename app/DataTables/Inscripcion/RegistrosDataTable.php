...
class RegistrosDataTable extends DataTable
{
     ...
     *
     * @param \App\Inscripcion/Registro $model
    ...
    {
        return $this->builder()
                    ->setTableId('inscripcion-registros-table')
                    ->columns($this->getColumns())
                    ->minifiedAjax()
                    ->ajax(['data' => 'function(d) { d.table = "registrosTable"; }'])
    ...
    {
        return 'Inscripcion_Registros_' . date('YmdHis');
    }
}
