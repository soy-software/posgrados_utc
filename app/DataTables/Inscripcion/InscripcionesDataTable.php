...
class InscripcionesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('action', function($inscri){
                return view('inscripciones.accionInscritos',['inscri'=>$inscri])->render();
            });
    }
     ...
     *
     * @param \App\Inscripcion/Inscripcione $model
    ...
    {
        return $this->builder()
                    ->setTableId('inscripcion-inscripciones-table')
    ...
    {
        return 'Inscripcion_Inscripciones_' . date('YmdHis');
    }
}
